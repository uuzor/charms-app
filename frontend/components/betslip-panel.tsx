      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-96 bg-gradient-to-br from-gray-900 to-black border-l border-white/10 backdrop-blur-xl z-50 flex flex-col shadow-2xl"
          >
            {/* Header */}
